...
**To ship a change:** edit the section -> `git push` -> `git tag v1.7.1 && git push --tags` ->
change `@v1.7.0` to `@v1.7.1` in the header snippet. That number is the only thing you edit in Squarespace.
